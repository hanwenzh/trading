...
namespace Model.DB
{
    ...
    public class Unit : Base
    {
        ...
        [DataMember]
        public decimal capital_available { get { return Math.Max(capital_balance - capital_freezing - capital_scale * ratio_freezing, 0); } set { } }
        ...
        [UnValue]
        public OrderPriceLimitEnum limit_order_price_enum
        {
            get { return (OrderPriceLimitEnum)limit_order_price; }
            set { limit_order_price = (int)value; }
        }
